			...
			buttons : [ 'copyHtml5', 'pdfHtml5' ,'colvis',
				 ...
				 customize: function(xlsx)
				 {
					...
					$('row c[r*="100"]', sheet).attr('s', '25');
				      ...
				      var dt = new Date();
				      var time = dt.getHours() + ":" + dt.getMinutes() + ":" + dt.getSeconds();
	var r1 = Addrow(1, [{ key: 'A', value: 'DATE:'+d }, { key: 'B', value: 'TIME:'+time}, { key: 'C', value: '' },{ key: 'D', value: 'DAILY STATUS REPORT' },{ key: 'E', value: '' },{ key: 'F', value: '' },{ key: 'G', value: '' },{ key: 'H', value: '' },{ key: 'I', value: '' }]);
