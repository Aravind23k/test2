...
<div class="row">
 ...
 <div class = "panel-body">
  ...
  <div class="form-group col-lg-6">
      ...
      <input type="input" class="form-control" id="emp_name" required> 
    </div>
    <div class="form-group col-lg-6 col-md-6">
      <label for="emp_id">Employee ID:</label>	 
      <input type="input" class="form-control" id="emp_id"  required>
    </div>
	<div class="form-group col-lg-6 col-md-6">
		<label for="admin_pref" class="control-label">Admin Preference:</label>
		<select class="form-control" id="admin_pref">
	...
	<div class="form-group col-lg-6 col-md-6">	  
      ...
      <input type="email" class="form-control" id="conf_pwd" required>
    </div>
